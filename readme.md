...
本项目为C++全栈聊天项目实战，包括PC端QT界面编程，asio异步服务器设计，beast网络库搭建http网关，node.js搭建验证服务，各服务间通过grpc通信，server和client使用asio通信等。实现跨平台设计，先设计windows的server，之后再考虑移植到linux中，较为全面的展示C++ 在实际项目中的应用。

# 架构设计

![架构设计](./client/res/img/Architectural.jpg)
...
- 本人的笔记地址：[飞书云文档](https://ai.feishu.cn/drive/folder/Z73HfvifZlBuacdxXg6cqSbhnaf)